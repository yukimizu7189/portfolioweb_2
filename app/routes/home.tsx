...
export function meta({}: Route.MetaArgs) {
  return [{ title: "yukimizu | Portfolio" }];
}
  ...
  return (
    <div className="space-y-32 pb-24">
      ...
      <section className='px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto'> 
        <div className="flex justify-between items-end mb-8 border-b border-gray-700 pb-4">
          <div>
            <h2 className="text-3xl font-bold text-white">Banner</h2>
            <p className="text-gray-400 mt-1">リンク先と私は無関係です</p>
          </div>
        </div>
        <div className="flex flex-col grid lg:flex-row lg:grid-cols-3 pb-20 justify-center">
          <a href="https://love.tsukuba-ac.net/" target="_blank" rel="noreferrer">
            <img src="https://love.tsukuba-ac.net/tsukuba-love1.png" className='mx-auto mb-4' width = "200" height = "40" alt="つくば大好き連合"></img>
          </a>
